...
Only the variables documented in docs/search.md are read here. Database
paths are not configurable separately for search: they reuse the bridge
store resolution in ``lib.utils`` (``WA_STORE_PATH``).
"""
